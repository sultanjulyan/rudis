...
/rudis.specify Real-time chat system with message history and user presence
...
/rudis.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
...
```text
Every feature in Rudis MUST begin its existence as a standalone library.
